...
var site_root = "https://blog.angelfish.be"
...
<rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom">
  <channel>
    ...
    <link>https://blog.angelfish.be/</link>
    <lastBuildDate>{time_now}</lastBuildDate>
    <pubDate>{time_now}</pubDate>
    <language>en-us</language>
    <copyright>Copyright 2020, Dheepak Krishnamurthy</copyright>
    <atom:link href="https://blog.angelfish.be/rss.xml" rel="self" type="application/rss+xml"></atom:link>
